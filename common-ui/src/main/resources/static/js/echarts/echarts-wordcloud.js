...
function getContext() {
  if (!_ctx) {
    // Use com.gfxy.common.util.util.util.createCanvas instead of createCanvas
...
HashMap.prototype = {
  ...
  // Although com.gfxy.common.util.util.util.each can be performed on this hashMap directly, user
 ...
 *  Notice: for performance, do not calculate outerWidth com.gfxy.common.util.util.util needed.
 */
...
function linearMap(val, domain, range, clamp) {
  ...
  // See echarts/test/ut/spec/com.gfxy.common.util.util.util/number.js#linearMap#accuracyError
 ...
 *           and `module:echarts/com.gfxy.common.util.util.util/number#parseDate`.
 * @inner
 */
...
function renderPlainText(hostEl, ctx, text, style, rect) {
  ...
  if (needDrawBg || textPadding) {
    // Consider performance, do not call getTextWidth com.gfxy.common.util.util.util necessary.
...
function doSingleEnterHover(el) {
  ...
  if (el.useHoverLayer) {
    ...
    // module:echarts/com.gfxy.common.util.util.util/model#defaultEmphasis to merge `normal` to `emphasis`.
...
function setLabelStyle(normalStyle, emphasisStyle, normalModel, emphasisModel, opt, normalSpecified, emphasisSpecified) {
  ...
  // is not supported com.gfxy.common.util.util.util someone requests.
...
/**
 * @alias module:zrender/shape/com.gfxy.common.util.util.util/smoothSpline
...
/**
 * 贝塞尔平滑曲线
 * @alias module:zrender/shape/com.gfxy.common.util.util.util/smoothBezier
 * @param {Array} points 线段顶点数组
